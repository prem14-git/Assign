  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-40 right-1/2 opacity-20 animate-bounce" style={{animationDuration: '5s', animationDelay: '1.5s'}}>
          <span className="text-3xl">🦋</span>
        </div>
      </div>
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl p-10 shadow-2xl border border-emerald-100/50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-2">with Arvyax</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Success Message */}
              {success && (
                <div className="bg-green-50/90 backdrop-blur-sm border-2 border-green-200 rounded-2xl p-4 shadow-lg">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 w-8 h-8 bg-green-100 rounded-xl flex items-center justify-center mr-3">
                      <span className="text-lg">🎉</span>
                    </div>
                    <div>
                      <p className="text-green-800 font-semibold text-sm">{success}</p>
                      <p className="text-green-600 text-xs mt-1">Welcome to your wellness journey!</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="relative z-10 flex items-center justify-center">
                  {loading ? (
                    <>
                      ...
                      <span className="text-lg">Creating your sanctuary...</span>
                    </>
                  ) : (
                    <>
                      <span className="mr-3 text-xl group-hover:scale-110 transition-transform duration-200">🌟</span>
                      <span className="text-lg">Start Your Wellness Journey</span>
            ...
            <div className="mt-8">
              <div className="bg-gradient-to-r from-emerald-50/80 to-teal-50/80 rounded-2xl p-6 border border-emerald-100 text-center">
                <p className="text-emerald-700 font-medium mb-3">Already part of the community?</p>
                <a
                  href="/login"
            ...
            <div className="mt-8 text-center">
              <div className="bg-gradient-to-r from-emerald-50/60 to-teal-50/60 rounded-2xl p-4 border border-emerald-100/50">
                <p className="text-emerald-700 font-medium text-sm mb-1">💫 Welcome Blessing</p>
                <p className="text-emerald-600 text-xs italic">
                  "Every new beginning comes from some other beginning's end. Welcome home."
                </p>
              </div>
            </div>
          </div>
